...
public class produitLi extends BaseAdapter {
    ...
    public produitLi(Activity context , ArrayList<Produit> produits) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            convertView =inflater.inflate(R.layout.produita, null);
        }
